...
{
    /// <inheritdoc />
    public partial class Phase20_AiIntegration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponseSummary = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_McpAuditLogs_PerformedAt",
                table: "McpAuditLogs",
                column: "PerformedAt");

            migrationBuilder.CreateIndex(
                name: "IX_McpAuditLogs_ToolName",
                table: "McpAuditLogs",
                column: "ToolName");
