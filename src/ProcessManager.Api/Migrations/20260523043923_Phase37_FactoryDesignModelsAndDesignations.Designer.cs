...
namespace ProcessManager.Api.Migrations
{
    ...
    [Migration("20260523043923_Phase37_FactoryDesignModelsAndDesignations")]
    partial class Phase37_FactoryDesignModelsAndDesignations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.DomainVocabulary", b =>
                {
                    ...
                    b.Property<string>("TermWorkorder")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.FloorPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.FloorPlanInventoryLocation", b =>
                {
                    ...
                    b.HasIndex("FloorPlanId", "PlacementId")
                        .IsUnique();

                    b.HasIndex("FloorPlanId", "StorageLocationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.FloorPlanWorkstation", b =>
                {
                    ...
                    b.ToTable("FloorPlanWorkstations");
                });

            modelBuilder.Entity("ProcessManager.Domain.Entities.FloorPlanWorkstationProcess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("FloorPlanWorkstationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FloorPlanWorkstationId", "ProcessId")
                        .IsUnique();

                    b.ToTable("FloorPlanWorkstationProcesses");
                });

            modelBuilder.Entity("ProcessManager.Domain.Entities.FloorPlanWorkstationTool", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FloorPlanWorkstationId", "KindId")
                        .IsUnique();

                    b.ToTable("FloorPlanWorkstationTools");
                });
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.InventoryTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TransactedByUserId")
                        .IsRequired()
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.McpAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.PickList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.PickListLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.StepTemplate", b =>
                {
                    ...
                    b.Property<Guid?>("KindModelRefId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.StorageLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.FloorPlanInventoryLocation", b =>
                {
                    b.HasOne("ProcessManager.Domain.Entities.FloorPlan", "FloorPlan")
                        .WithMany("InventoryLocations")
                        .HasForeignKey("FloorPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProcessManager.Domain.Entities.StorageLocation", "StorageLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.FloorPlanWorkstationProcess", b =>
                {
                    b.HasOne("ProcessManager.Domain.Entities.FloorPlanWorkstation", "FloorPlanWorkstation")
                        .WithMany("Processes")
                        .HasForeignKey("FloorPlanWorkstationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("FloorPlanWorkstation");
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.InventoryTransaction", b =>
                {
                    b.HasOne("ProcessManager.Domain.Entities.StorageLocation", "FromLocation")
                        .WithMany()
                    ...
                    b.HasOne("ProcessManager.Domain.Entities.StorageLocation", "ToLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.Job", b =>
                {
                    b.HasOne("ProcessManager.Domain.Entities.PickList", "PickList")
                        .WithOne("Job")
                        .HasForeignKey("ProcessManager.Domain.Entities.Job", "PickListId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.PickListLine", b =>
                {
                    ...
                    b.HasOne("ProcessManager.Domain.Entities.StorageLocation", "SourceLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.StepModel", b =>
                {
                    b.HasOne("ProcessManager.Domain.Entities.StepTemplate", "StepTemplate")
                        .WithOne("StepModel")
                        .HasForeignKey("ProcessManager.Domain.Entities.StepModel", "StepTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.StepTemplate", b =>
                {
                    b.HasOne("ProcessManager.Domain.Entities.Kind", "KindModelRef")
                        .WithMany()
                        .HasForeignKey("KindModelRefId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("ProcessManager.Domain.Entities.StorageLocation", b =>
                {
                    b.HasOne("ProcessManager.Domain.Entities.StorageLocation", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
